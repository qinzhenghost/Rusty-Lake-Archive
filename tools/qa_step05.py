...
check('reader:language-persistence', 'useArchiveLanguage' in reader and 'rla-language-v1' in language_lib and 'localStorage.setItem(LANGUAGE_KEY' in language_hook, 'global language mode is not persisted')
